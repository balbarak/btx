...
using PortableListView = Btx.Mobile.CustomRenders.ScrollListViewRender;

[assembly: Xamarin.Forms.ExportRenderer(
    typeof(Btx.Mobile.CustomRenders.ScrollListViewRender),
    typeof(Btx.Mobile.Droid.CustomRenders.ScrollListViewRender))]
namespace Btx.Mobile.Droid.CustomRenders
{
    public class ScrollListViewRender : ListViewRenderer
    {
        public ScrollListViewRender(Context context) : base(context)
        {
